...
const PRODUCTS = [
  ...
  },
  {
    ...
    stock: 7,
    image: "logo-dominio.png",
    images: ["logo-dominio.png"],
    shortDescription: "Produto da linha de redes.",
    description: "Item de redes para ampliar organização e conectividade do ambiente comercial ou residencial.",
    specs: {
      Categoria: "Redes",
      Uso: "Conectividade",
      Aplicação: "Casa / empresa",
      Instalação: "Simples",
      Marca: "Domínio",
      Estrutura: "Compacta"
    }
  },
  {
    ...
    description: "Teclado KB-14BK C3Tech USB 1.2m com fio, membrana anti respingo, ideal para rotina de escritório. Design sofisticado, 107 teclas, ajuste de altura e uso confortável no dia a dia.",
    specs: {
      Marca: "C3Tech",
      Modelo: "KB-14BK",
      Layout: "ABNT2",
